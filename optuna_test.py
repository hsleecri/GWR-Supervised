...
def objective(trial, ds_iris,export_network_directory):
    ...
    #'''
    epochs = trial.suggest_int('epochs', 1, 100)
    a_threshold = trial.suggest_float('a_threshold', 0.3, 0.5)
...
if __name__ == "__main__":
    data_file = 'C:\\Users\\hslee\\Desktop\\dataset\\HYEONSU\\4공정\\CSV\\4공정_FRONT_CYCLE.mp4pose_world_interpolated_visibility제거_하반신제거_레이블_첫행제거_레이블값1뺐음_얼굴제거.csv'
